...
var MaterialButton = function (props) {
    ...
    //states
    var _b = React.useState(""), idStyles = _b[0], setIdStyles = _b[1];
    var _c = React.useState(false), styleInjected = _c[0], setStyleInjected = _c[1];
    var _d = React.useState(0), nextClassName = _d[0], setNextClassName = _d[1];
    var _e = React.useState(""), classNameCreated = _e[0], setClassNameCreated = _e[1];
    //effects
    ...
    var span_ref = React.useRef(null);
    /**
     *
     * @param e
     */
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null, styleInjected &&
        React__default['default'].createElement(href ? "a" : "button", {
            ...
            href: href,
            style: style,
            children: href ? (React__default['default'].createElement("span", { ref: span_ref, className: "label" }, children)) : (React__default['default'].createElement("span", { className: "label" }, children)),
            disabled: disabled,
        })));
};
