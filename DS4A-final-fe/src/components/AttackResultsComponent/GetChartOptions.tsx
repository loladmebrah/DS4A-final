...
const renderer = () => {
    return {
        'linerace': getLineRace,
        'radialpolar': getRadialOption,
        'radar': getRadarOption,
        '3dscatter': get3DScatter,

    }
}


function getLineRace(): any {
    const countries = [
        'Finland',
        'France',
        'Germany',
      ...
      echarts.util.each(countries, function (country: any) {
...
function getRadialOption(): any{
    const data = [
        [Math.floor(Math.random() * 35) + 1, Math.floor(Math.random() * (75-35+1)) + 35, Math.floor(Math.random() * (100-75+1)) + 75],
        [Math.floor(Math.random() * 35) + 1, Math.floor(Math.random() * (75-35+1)) + 35, Math.floor(Math.random() * (100-75+1)) + 75],
        [Math.floor(Math.random() * 35) + 1, Math.floor(Math.random() * (75-35+1)) + 35, Math.floor(Math.random() * (100-75+1)) + 75],
        [Math.floor(Math.random() * 35) + 1, Math.floor(Math.random() * (75-35+1)) + 35, Math.floor(Math.random() * (100-75+1)) + 75],
        [Math.floor(Math.random() * 35) + 1, Math.floor(Math.random() * (75-35+1)) + 35, Math.floor(Math.random() * (100-75+1)) + 75],
